...
export const FiltersSkeleton = () => {
  return (
    <aside className="md:w-1/3 lg:w-1/4 px-4">
      <div className="hidden md:block px-6 py-4 border border-gray-200 bg-white rounded shadow-sm animate-pulse">
        {/* Skeleton for Price Filter */}
        <div className="mb-4">
